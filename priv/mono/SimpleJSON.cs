...
namespace SimpleJSON
{
	...
	public abstract class JSONNode
	{
		...
		public virtual JSONNode this [int aIndex]   { get { return JSONEmpty.singleton; } set { } }
		
		public virtual JSONNode this [string aKey]  { get { return JSONEmpty.singleton; } set { } }
	...
	public class JSONArray : JSONNode, IEnumerable
	{
		...
		{
			get{ return JSONEmpty.singleton; }
	...
	public class JSONEmpty : JSONNode
	{
		public static readonly JSONEmpty singleton = new JSONEmpty();

		public override void Add (string aKey, JSONNode aItem)
		{
		}
		
		public override JSONNode this [int aIndex]   { get { return this; } set { } }
		
		public override JSONNode this [string aKey]  { get { return this; } set { } }
		...
		public override string ToJSON (int prefix)
		{
			throw new Exception("Should not create JSON string from JSONEmpty");
		}
		...
		static JSONArray _array = new JSONArray();
		...
		static JSONClass _class = new JSONClass();
		...
		public static bool operator == (JSONEmpty a, object b)
		{
			if(b == null){
				return true;
			}
